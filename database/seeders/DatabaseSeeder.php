...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //insertGetId() this method return an array of ids or only the last id ?
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            $product->minimum_amount = rand(10, 20); //The rand() function generates a random integer.
